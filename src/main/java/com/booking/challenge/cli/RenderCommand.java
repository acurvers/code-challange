package com.booking.challenge.cli;

import com.booking.challenge.FlightBookingConfiguration;
...
public class RenderCommand extends ConfiguredCommand<FlightBookingConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<FlightBookingConfiguration> bootstrap,
                       Namespace namespace,
                       FlightBookingConfiguration configuration) throws Exception {
